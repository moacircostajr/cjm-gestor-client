...
/***/ "./src/app/services/padroes.service.ts":
/*!*********************************************!*\
  !*** ./src/app/services/padroes.service.ts ***!
  \*********************************************/
/*! exports provided: PadroesService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PadroesService", function() { return PadroesService; });
...
var PadroesService = /** @class */ (function () {
    function PadroesService(httpClient, loginService) {
        this.httpClient = httpClient;
        this.loginService = loginService;
    }
    Object.defineProperty(PadroesService.prototype, "header", {
        get: function () {
    ...
    Object.defineProperty(PadroesService.prototype, "empresa", {
        get: function () {
    ...
    PadroesService.prototype.registrarClassificacao = function (classificacao) {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/registrar/classificacao', classificacao, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    PadroesService.prototype.registrarBancas = function (bancas) {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/registrar/bancas', bancas, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    PadroesService.prototype.registrarConcursos = function (concursos) {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/registrar/concursos', concursos, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    PadroesService.prototype.obterClassificacao = function () {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/padrao_classificacao', this.empresa, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    PadroesService.prototype.obterBancas = function () {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/padrao_bancas', this.empresa, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    PadroesService.prototype.obterConcursos = function () {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/padrao_concursos', this.empresa, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    PadroesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/services/questao-service.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/questao-service.service.ts ***!
  \*****************************************************/
/*! exports provided: QuestaoServiceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuestaoServiceService", function() { return QuestaoServiceService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Config */ "./src/app/services/Config.ts");
...
var QuestaoServiceService = /** @class */ (function () {
    function QuestaoServiceService(httpClient, loginService) {
        this.httpClient = httpClient;
        this.loginService = loginService;
    }
    Object.defineProperty(QuestaoServiceService.prototype, "header", {
        get: function () {
            return this.loginService.header;
        },
        enumerable: true,
    ...
    Object.defineProperty(QuestaoServiceService.prototype, "empresa", {
        get: function () {
    ...
    QuestaoServiceService.prototype.enviaExercicio = function (exercicio) {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/registrar/exercicio', exercicio, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    QuestaoServiceService.prototype.obterExercicios = function () {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/exercicios', this.empresa, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    QuestaoServiceService.prototype.acessarExercicio = function (id) {
        return this.httpClient.get(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/exercicio/' + id, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    QuestaoServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
            _login_service__WEBPACK_IMPORTED_MODULE_4__["LoginService"]])
    ], QuestaoServiceService);
    return QuestaoServiceService;
}());
...
var UsuariosService = /** @class */ (function () {
    function UsuariosService(httpClient, loginService) {
        this.httpClient = httpClient;
        this.loginService = loginService;
    }
    Object.defineProperty(UsuariosService.prototype, "header", {
        get: function () {
            return this.loginService.header;
        },
        enumerable: true,
    ...
    UsuariosService.prototype.obterUsuarios = function (empresa) {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/usuarios', empresa, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    UsuariosService.prototype.obterUsuario = function (idUsuario) {
        return this.httpClient.get(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/usuario/' + idUsuario, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
    UsuariosService.prototype.registrarUsuario = function (usuario) {
        return this.httpClient.post(_Config__WEBPACK_IMPORTED_MODULE_3__["Config"].SERV_URL + '/api/cursos/usuario', usuario, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](this.header) });
    };
